 ...
 * usage:
 *
 * java Program1 inputFilename maxOrder [vocabFilename countsFilename]
 *
 * where the arguments are
 * 
 *   inputFileName         a plaintext file from which your program will
 *                         estimate counts
 *   maxOrder              the maximum n-gram order to estimate and report
 *                         results on
